...
const HeartIcon = () => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={1.5}
      d="M4.318 6.318a4.5 4.5 0 010 6.364L12 20.364l7.682-7.682a4.5 4.5 0 01-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 01-6.364 0z"
    />
  </svg>
);
const BagIcon = () => (
    ...
    <>
      <header className="sticky top-0 z-40 bg-cream/80 backdrop-blur-md border-b border-beige">
        <Container className="flex items-center justify-between h-20">
          ...
          <div className="absolute left-1/3 -translate-x-1/2 md:relative md:left-0 md:translate-x-0">
            <Link
              to="/"
              className="font-serif text-3xl tracking-widest text-soft-black"
            >
              DEMO
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Link to="/wishlist" className="relative">
              ...
              {wishlistCount > 0 && (
                <span className="absolute top-0 right-0 block h-4 w-4 rounded-full bg-rose text-white text-xs text-center">
                  {wishlistCount}
                </span>
              )}
            </Link>
